...
@section('title', 'Create Product Type - Creative AI')
...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="fw-bold mb-1">Create New Product Type</h3>
                        <p class="text-muted mb-0">Add a new product type for Creative AI</p>
                    </div>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.creative-ai.product-types.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary rounded-pill">
                                    <i class="fas fa-save me-2"></i> Create Product Type
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Check if industry is already selected (e.g. invalid submission reload)
