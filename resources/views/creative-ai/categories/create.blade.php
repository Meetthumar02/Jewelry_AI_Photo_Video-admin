...
@section('title', 'Create Category - Creative AI')
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="fw-bold mb-1">Create New Category</h3>
                        <p class="text-muted mb-0">Add a new category for Creative AI</p>
                    </div>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.creative-ai.categories.store') }}" method="POST">
                            @csrf
